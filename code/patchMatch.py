...
class PatchMatch:
    ...
    def read_image(self, filename: str, key: str) \
        ...
        """
        success = False
        msg = 'No Image Available for read'

        #########################################
        ## PLACE YOUR CODE BETWEEN THESE LINES ##
        #########################################
        
        # COPY INTO THIS SPACE YOUR IMPLEMENTATION OF FUNCTION readImage()
        # FROM YOUR algorithm.py of A3
        img = cv.imread(filename,1)
        self._images[key] = img
        success = cv.haveImageReader(filename)
        #########################################
    ...
    def write_image(self, filename: str, key: str) \
        ...
        success = False
        msg = 'No Image Available for write'

        #########################################
        ## PLACE YOUR CODE BETWEEN THESE LINES ##
        #########################################

        # COPY INTO THIS SPACE YOUR IMPLEMENTATION OF FUNCTION writeImage
        # FROM YOUR algorithm.py of A3
